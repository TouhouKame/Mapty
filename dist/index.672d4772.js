...
class App {
    ...
    _loadMap(position) {
        ...
        console.log(`https://www.google.ca/maps/@${latitude},${longitude},7z?entry=ttu`);
        const coords = [
            latitude,
            longitude
        ];
    ...
    _newWorkout(e) {
        ...
        if (type === "running") {
            ...
            if (!validInputs(distance, duration, cadence) || !allPositive(distance, duration, cadence)) return alert("Inputs must be positive numbers!");
            workout = new Running([
                lat,
                lng
        ...
        if (type === "cycling") {
            ...
            if (!validInputs(distance, duration, elevation) || !allPositive(distance, duration)) return alert("Inputs must be positive numbers!");
            workout = new Cycling([
                lat,
                lng
